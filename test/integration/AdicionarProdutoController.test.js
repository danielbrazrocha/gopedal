...
describe('Integration Test AdicionarProdutoController', function () {
//   beforeEach(() => {
...
//   })
  ...
  test('should give a 302 redirect when access / without auth', async () => {
    // Arrange
    // Act
    const res = await request(app).get('/adicionarProduto')
    // Assert
